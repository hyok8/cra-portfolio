...
function App() {
  return (
    <div className="khjproject">
      <Hd datainfo={db.navi} cls="fixed-top border-bottom bg-white"></Hd>
      ...
      <Preinterview id="preInterview" datainfo={db.preinterview} cls="vh-100 bg-red"></Preinterview>
